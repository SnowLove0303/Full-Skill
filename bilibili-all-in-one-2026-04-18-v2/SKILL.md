...
description: B站唯一入口技能，整合原 bilibili-news、bilibili-opencli、bilibili-monitor 及其脚本模块；支持 AI早报、站内搜索、视频下载转录、Obsidian笔记、热门日报和邮件推送。触发词：B站早报/AI日报/热门监控/邮件推送/bilibili搜索/bilibili监控/bilibili视频
triggers:
  - B站早报
  - AI早报
  - bilibili日报
...
- 遇到 B站、Bilibili、视频日报、AI早报、UP主视频、转录、Obsidian笔记、热门视频邮件等需求时，先读本文件，再按“快速选择指南”选内部模块。
